		...
		var ue = F,
			...
			Ke = function( e ) {
				( Be && Be === e ) ||
					( ( e &&
						'object' ===
							( void 0 === e ? 'undefined' : W( e ) ) ) ||
						( e = {} ),
					( he = 'ALLOWED_TAGS' in e ? L( {}, e.ALLOWED_TAGS ) : ve ),
					( be = 'ALLOWED_ATTR' in e ? L( {}, e.ALLOWED_ATTR ) : Te ),
					( Ge =
						'ADD_URI_SAFE_ATTR' in e
							? L( _( We ), e.ADD_URI_SAFE_ATTR )
							: We ),
					( je =
						'ADD_DATA_URI_TAGS' in e
							? L( _( Pe ), e.ADD_DATA_URI_TAGS )
							: Pe ),
					( Ae = 'FORBID_TAGS' in e ? L( {}, e.FORBID_TAGS ) : {} ),
					( xe = 'FORBID_ATTR' in e ? L( {}, e.FORBID_ATTR ) : {} ),
					( Ie = 'USE_PROFILES' in e && e.USE_PROFILES ),
					( Se = ! 1 !== e.ALLOW_ARIA_ATTR ),
					( ke = ! 1 !== e.ALLOW_DATA_ATTR ),
					( Le = e.ALLOW_UNKNOWN_PROTOCOLS || ! 1 ),
					( _e = e.SAFE_FOR_JQUERY || ! 1 ),
					( Ee = e.SAFE_FOR_TEMPLATES || ! 1 ),
					( Me = e.WHOLE_DOCUMENT || ! 1 ),
					( Ne = e.RETURN_DOM || ! 1 ),
					( Oe = e.RETURN_DOM_FRAGMENT || ! 1 ),
					( we = e.RETURN_DOM_IMPORT || ! 1 ),
					...
					Ie &&
						( ( he = L( {}, [].concat( B( N ) ) ) ),
						( be = [] ),
						! 0 === Ie.html && ( L( he, E ), L( be, O ) ),
						! 0 === Ie.svg &&
							( L( he, M ), L( be, w ), L( be, C ) ),
						! 0 === Ie.svgFilters &&
							( L( he, D ), L( be, w ), L( be, C ) ),
						! 0 === Ie.mathMl &&
							( L( he, R ), L( be, H ), L( be, C ) ) ),
					e.ADD_TAGS &&
						( he === ve && ( he = _( he ) ), L( he, e.ADD_TAGS ) ),
					e.ADD_ATTR &&
						( be === Te && ( be = _( be ) ), L( be, e.ADD_ATTR ) ),
					e.ADD_URI_SAFE_ATTR && L( Ge, e.ADD_URI_SAFE_ATTR ),
					Fe && ( he[ '#text' ] = ! 0 ),
					Me && L( he, [ 'html', 'head', 'body' ] ),
					he.table && ( L( he, [ 'tbody' ] ), delete Ae.tbody ),
					o && o( e ),
					( Be = e ) );
			},
			Ve = function( e ) {
			...
			Xe = function( e ) {
				...
				if (
					( a && L( Ae, [ 'title' ] ), ! t || ! t.documentElement )
				) {
		...
		n.isSupported &&
			( function() {
				try {
					...
					T( /<\/title/, e.querySelector( 'title' ).innerHTML ) &&
						( a = ! 0 );
				} catch ( e ) {}
			} )();
		var $e = function( e ) {
			...
			Qe = function( e ) {
				return 'object' === ( void 0 === k ? 'undefined' : W( k ) )
					? e instanceof k
					: e &&
							'object' ===
								( void 0 === e ? 'undefined' : W( e ) ) &&
					...
					if (
						...
						try {
							...
							e.insertAdjacentHTML(
								'AfterEnd',
								te ? te.createHTML( o ) : o
							);
						} catch ( e ) {}
					return Ve( e ), ! 0;
				}
				return ( 'noscript' === r &&
					T( /<\/noscript/i, e.innerHTML ) ) ||
					( 'noembed' === r && T( /<\/noembed/i, e.innerHTML ) )
					? ( Ve( e ), ! 0 )
					: ( ! _e ||
							e.firstElementChild ||
			...
			rt = function e( t ) {
				var n = void 0,
					r = $e( t );
				for (
					Ze( 'beforeSanitizeShadowDOM', t, null );
					( n = r.nextNode() );
			...
			( n.sanitize = function( e, r ) {
				...
				if (
					...
					( 1 ===
						( a = ( o = Xe(
							'\x3c!--\x3e'
						) ).ownerDocument.importNode( e, ! 0 ) ).nodeType &&
						'BODY' === a.nodeName ) ||
					'HTML' === a.nodeName
						? ( o = a )
						: o.appendChild( a );
				else {
					if ( ! Ne && ! Ee && ! Me && -1 === e.indexOf( '<' ) )
				...
				for ( var d = $e( ze ? e : o ); ( l = d.nextNode() );  )
					( 3 === l.nodeType && l === s ) ||
						et( l ) ||
						( l.content instanceof c && rt( l.content ),
						nt( l ),
						( s = l ) );
